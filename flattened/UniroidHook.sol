...
contract UniroidHook is BaseHook, ERC20 {
    // Hook data keys
    uint8 public constant KEY_USER_ADDRESS = 1;
    uint8 public constant KEY_REFERRER_ADDRESS = 2;
    uint8 public constant KEY_REFERRAL_TYPE = 3;
    uint8 public constant KEY_CUSTOM_DATA = 4;
    // Add more keys as needed in the future

    // Referral types
    uint8 public constant REFERRAL_TYPE_NONE = 0;
    uint8 public constant REFERRAL_TYPE_FEE_COMMISSION = 1;
    
    // Referral fee commission percentage (50%)
    uint8 public constant REFERRAL_FEE_COMMISSION_PERCENT = 50;
    ...
    uint256 public constant LOCK_PERIOD_DURATION = 7 days;

    // Minimum liquidity threshold required for initialization (0.1 ETH)
    uint256 public constant MINIMUM_LIQUIDITY_THRESHOLD = 0.1 ether;

    // Premium subscription price (1 ETH)
    uint256 public constant PREMIUM_SUBSCRIPTION_PRICE = 1 ether;

    // Premium subscription duration (1 year)
    uint256 public constant PREMIUM_SUBSCRIPTION_DURATION = 365 days;

    // Premium user fee discount percentage (50%)
    uint8 public constant PREMIUM_FEE_DISCOUNT_PERCENT = 50;
